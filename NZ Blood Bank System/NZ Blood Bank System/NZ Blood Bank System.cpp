...
void recipientRegFunc() {           
    ...
    cout << "(Make sure to fill every field so your account is Validated)";
...
void recipFrontPage() {
    ...
    if (recipMenuChoice == "1") {
        ...
        cout << "\t[1]Type A\t\t[3]Type B" << endl << "\t[2]Type AB\t\t[4]Type O" << endl << endl;
    BloodSearchRestart:
        cout << "Please Select an Option: "; cin >> bloodOnlySearch; 
